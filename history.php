...
$keywords="botanical, park, aarhus, green, nature, denmark, city center, trees, history, den gamle by, science museum, greenhouses, volunteers";
 include("includes/head.php"); ?>
	...
	<body>
		...
		The garden grew gradually, and by the end of 1946 it reached 21.5 hectares in size, which is how it stands today.</p><br>
		...
		<div class="maps">
		<div class="newMap">
			<img src="pictures/areas-mapphotoshop.jpg" alt="New map">
		</div>
		<div class="oldMap">
			<img src="pictures/old_map2.jpg" alt="Old map">
		</div>
		</div>
