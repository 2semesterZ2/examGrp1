...
<html>
	...
	<body>
		...
		<p>There is no maintenance being carried out today :)<br />
		We are mowing the lawns [insert area description] from 10am.<br />
		The ponds are being cleaned over the next week, starting on [insert date].<br />
		A sick tree is being removed from [insert area description] today.</p>
